...
%%
function [cost,msll,beamw,eccen,GD]= costs_lite1000(pattern,mask2,SU,SV,pbi)
alpha=0.5;beta=0.5;gamma=0.5;psi=10;%20
...
beamw=sqrt(bd1.^2+bd2.^2);% NOTE: This is overall BW
msll=(pm2-pm);
